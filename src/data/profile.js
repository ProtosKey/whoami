export const profile = {
  name: 'Газизуллин Ринат Ришатович',
  location: 'Санкт-Петербург',
  education: 'Университет ИТМО, 3 курс',
  specialization: 'Системное и прикладное программное обеспечение',
  english: 'B1–B2',
};
...
export const categories = [
  { id: 'mobile', title: 'Мобильная разработка' },
  { id: 'systems', title: 'Системное программирование' },
  { id: 'other', title: 'Остальные проекты' },
];
